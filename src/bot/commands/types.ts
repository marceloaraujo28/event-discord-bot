...
export type SellerType = BaseType & { event: EventType; guildData: Guilds };
...
export type DepositMemberType = BaseType & { guildData: Guilds };
export type ArchiveEventType = BaseType & { guildData: Guilds };
export type UpdatePriceLangType = BaseType;
